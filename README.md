...
credentials. With them the suite is 53 passed, no skips. That test is verified not to pass
...
- The fabrication guard is tested against live Granite, not a mock. That test is
  ...
  precise way an earlier version of it lied. With credentials the suite is 53
  passed; without them that one test skips and you see 52 passed, 1 skipped.
