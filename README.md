...
python3 -m pytest tests/ -q       # 170 passed, 1 skipped
```
...
credentials. With them the suite is 171 passed, no skips. That test is verified not to pass
...
- The fabrication guard is tested against live Granite, not a mock. That test is
  ...
  precise way an earlier version of it gave a false pass. With credentials the suite is 171
  passed; without them that one test skips and you see 170 passed, 1 skipped.
