...
credentials. With them the suite is 120 passed, no skips. That test is verified not to pass
...
- The fabrication guard is tested against live Granite, not a mock. That test is
  ...
  precise way an earlier version of it gave a false pass. With credentials the suite is 120
  passed; without them that one test skips and you see 119 passed, 1 skipped.
