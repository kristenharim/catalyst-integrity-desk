...
Prompts 1, 2 and 3 are done. Prompt 3 has one repair queued, the integrity badge.
Prompt 4, the panel, is cut for budget. Prompt 5, the README, is written from this
file.
